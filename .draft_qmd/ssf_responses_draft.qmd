...
ggplot(data = ndvi_hour_values,
  ...
  geom_raster() +
  labs(title = "harmonics(hour)", x = "Hour", y = "NDVI", fill = "Partial effect") +
...
ggplot(data = ndvi_hour_values,
  ...
  geom_raster() +
  labs(title = "harmonics(hour + hour^2)", x = "Hour", y = "NDVI", fill = "Partial effect") +
  geom_contour(aes(z = gam_log_rss), colour = "black") +
  scale_fill_distiller(palette = "RdBu", type = "div") +
  coord_cartesian(expand = FALSE) +
  theme_bw() 
...
ggplot(data = ndvi_hour_values,
  ...
  geom_raster() +
  labs(title = "s(hour, by = ndvi)", x = "Hour", y = "NDVI", fill = "Partial effect") +
  geom_contour(aes(z = gam_log_rss), colour = "black") +
  scale_fill_distiller(palette = "RdBu", type = "div") +
  coord_cartesian(expand = FALSE) +
  theme_bw() 
...
ggplot(data = ndvi_hour_values,
       aes(x = hour, y = ndvi, fill = gam_log_rss)) +
  geom_raster() +
  labs(title = "te(hour, ndvi)", x = "Hour", y = "NDVI", fill = "Partial effect") +
  geom_contour(aes(z = gam_log_rss), colour = "black") +
  scale_fill_distiller(palette = "RdBu", type = "div") +
  coord_cartesian(expand = FALSE) +
  theme_bw() 
