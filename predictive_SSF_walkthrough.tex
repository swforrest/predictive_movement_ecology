...
\NormalTok{n\_traj  }\OtherTok{\textless{}{-}} \DecValTok{10000}   \CommentTok{\# number of simulated trajectories (paper used 100,000)}
\NormalTok{n\_steps }\OtherTok{\textless{}{-}} \DecValTok{1440}     \CommentTok{\# steps per trajectory; 720 hourly steps = 30 days (paper used 3,000)}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_all_buffalo-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_individual-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_sampling_rate-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_covariates-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/used_vs_available-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_tentative-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_used_available_steps-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/static_response_curves-1.png}}
...
\begin{verbatim}
Fitting the temporally dynamic model: 96.96 sec elapsed
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/gam_draw-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_betas-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_movement_params-1.png}}
...
\begin{verbatim}
Building hourly selection surfaces: 0.334 sec elapsed
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_surfaces-1.png}}
...
\item
  ...
  until you count the draws. At 10000 × 1440 × 25 we make around 9
...
\begin{verbatim}
Simulating: A: static: 181.62 sec elapsed
\end{verbatim}
...
\begin{verbatim}
Simulating: B: temporally dynamic: 183.168 sec elapsed
\end{verbatim}
...
\begin{verbatim}
Simulated locations - static: 14160000  dynamic: 14160000 
\end{verbatim}
...
\begin{verbatim}
Simulating: B: dynamic, observed start: 185.157 sec elapsed
\end{verbatim}
...
\begin{verbatim}
Simulating: example: 0.036 sec elapsed
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/example_trajectories-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_simulated_step_lengths-1.png}}
...
\begin{verbatim}
Aggregating simulations: 11.321 sec elapsed
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_uds-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_start_comparison-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/convergence-1.png}}
...
trajectories --- it has not levelled off, which means 10000 trajectories
is \textbf{not} enough to characterise the utilisation distribution at
that resolution. With 14,160,000 simulated locations spread over a 100 m
...
\begin{verbatim}
Building hourly UDs: 9.265 sec elapsed
\end{verbatim}
...
source(s)   : memory
names       :   hour_0,   hour_1,   hour_2,   hour_3,   hour_4,   hour_5, ...
min values  : 0.000044, 0.000044, 0.000042, 0.000063,  0.00008, 0.000058, ...
max values  : 0.000929, 0.000969, 0.000971, 0.000931, 0.000932,  0.00101, ...
\end{verbatim}
...
\begin{verbatim}
Extracting covariates at simulated locations: 8.569 sec elapsed
\end{verbatim}
...
1    25     0 24042.  -1.43e6  64.2   -0.304    8.95 -0.277        1 A: s~ 0.414
2    26     1 24041.  -1.43e6   0.680  0.423    9.37 -0.277        1 A: s~ 0.414
3    27     2 23979.  -1.44e6 103.    -0.868    8.50 -0.112        1 A: s~ 0.279
4    28     3 24146.  -1.44e6 168.    -2.24     6.26 -0.0863       1 A: s~ 0.269
5    29     4 24147.  -1.44e6   0.512 -1.07     5.20 -0.0863       1 A: s~ 0.269
6    30     5 24233.  -1.44e6 110.     1.74     6.94 -0.107        1 A: s~ 0.234
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_hourly_summaries-1.png}}
...
# A tibble: 2 x 3
  ...
  <chr>                    <dbl>   <dbl>
1 A: static                0.755   0.813
2 B: temporally dynamic    0.799   0.699
\end{verbatim}
...
1             A: static  0.772  0.765      0.007
2 B: temporally dynamic  0.712  0.860      0.148
\end{verbatim}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Do not read the whole-day comparison as a result}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

The two halves disagree --- and they disagree far more for the static
model than for the dynamic one. That tells us the whole-day index is not
measuring a stable property of the static model at this simulation
scale; it is largely measuring which cells happened to receive simulated
locations.

There is a reason the static model suffers most. Its habitat
coefficients are small, so its selection surface is nearly flat and the
simulated animals wander close to uniformly. Its utilisation
distribution is therefore mostly Monte Carlo noise, and a Boyce index
computed against it can land almost anywhere. (In an earlier run of this
document, before a change to the random-number generator, the static
model scored \textbf{0.729} on this same comparison rather than the
value above. Nothing about the model changed --- only the noise.)

So the honest reading of the table above is \emph{not} ``the dynamic
model predicts better'' and \emph{not} ``the static model predicts
better''. It is that \textbf{this comparison cannot currently
distinguish them}, and would need many more trajectories to do so.

There is a second reason not to lean on it even once converged: the
whole-day distribution pools every hour together, which averages away
exactly the thing the dynamic model knows --- \emph{when} the animal is
in each habitat. The hourly validation below asks a question that
pooling cannot hide, and, as we will see, gives a far more stable
answer.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_f_ratio-1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/kde_comparison-1.png}}
...
9     8         88     0.401                 0.590
10    9         90     0.205                 0.815
11   10         95    -0.019                 0.689
12   11         97    -0.174                 0.555
13   12         93    -0.267                 0.585
14   13         95    -0.142                 0.749
15   14         69    -0.096                 0.711
16   15         63    -0.254                 0.768
17   16         87    -0.183                 0.620
18   17         96    -0.088                 0.546
19   18         93     0.660                 0.517
20   19         96     0.718                 0.832
21   20         96     0.424                 0.799
22   21         97     0.556                 0.786
23   22         99     0.613                 0.874
24   23         99     0.705                 0.873
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/plot_hourly_validation-1.png}}
...
\begin{verbatim}
amt simulation: 33.602 sec elapsed
\end{verbatim}
...
2 26472.62 -1433153 2018-07-25 12:10:32 59.96667 mins       1
3 26438.53 -1433172 2018-07-25 13:10:30 59.96667 mins       1
4 26438.48 -1433170 2018-07-25 14:10:28 59.96667 mins       1
5 26476.55 -1433354 2018-07-25 15:10:26 59.96667 mins       1
6 26536.66 -1433355 2018-07-25 16:10:24 59.96667 mins       1
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{predictive_SSF_walkthrough_files/figure-pdf/amt_comparison-1.png}}
...
out not to be stable at this simulation scale: its two halves disagree,
and it moved dramatically between drafts of this document when nothing
but the random-number generator changed. It would have been easy to
report whichever value happened to appear and to construct a tidy story
around it.

Three cautions to carry away, in order of how easily they catch people
out:

\begin{itemize}
\tightlist
\item
  \textbf{Check whether a number is stable before interpreting it.} The
  split-half check in section 11 costs nothing, uses simulations you
  already have, and is the difference between a result and a
  coincidence.
\item
  \textbf{Check convergence, and believe it.} These utilisation
  distributions have \emph{not} converged at 10000 trajectories, and
...
None of this argues against the temporally dynamic approach --- the
hourly result is real, and it is the comparison the method is actually
about. It argues for putting the same care into validating a simulation
that went into fitting the model.
