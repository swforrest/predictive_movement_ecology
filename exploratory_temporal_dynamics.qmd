...
As we have some categorical and binary variables, we use the **mean** for the line, rather than the median, and it explains why some of the ribbons look weird, as the quantile doesn't change throughout the day. 
